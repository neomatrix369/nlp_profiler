...
from nlp_profiler.constants import (
    SENTIMENT_POLARITY_SCORE_COL,
    SENTIMENT_POLARITY_COL,
    SENTIMENT_POLARITY_SUMMARISED_COL,
)
from nlp_profiler.constants import (
    SENTIMENT_SUBJECTIVITY_COL,
    SENTIMENT_SUBJECTIVITY_SCORE_COL,
    SENTIMENT_SUBJECTIVITY_SUMMARISED_COL,
)
...
def apply_high_level_features(
    ...
    generate_features(heading, high_level_features_steps, new_dataframe, parallelisation_method)
