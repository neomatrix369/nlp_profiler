...
from nlp_profiler.granular_features.alphanumeric import gather_alpha_numeric, count_alpha_numeric  # noqa
...
def test_given_a_alphanumeric_text_when_parsed_then_return_alphanumeric_chars():
    ...
    # then
    assert expected_results == actual_results, "Didn't find the expected alpha numeric chars in the text"
...
def test_given_a_alphanumeric_text_when_counted_then_return_number_of_alphanumeric_chars():
    ...
    # then
    assert expected_results == actual_results, "Didn't find the expected number of alpha numeric chars in the text"
