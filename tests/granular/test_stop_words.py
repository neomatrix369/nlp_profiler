...
from nlp_profiler.granular_features.stop_words import gather_stop_words, count_stop_words  # noqa
...
def test_given_a_text_with_stop_words_when_parsed_then_return_only_the_stop_words():
    ...
    # then
    assert expected_results == actual_results, "Didn't find the expected words in the text"
...
def test_given_a_text_with_stop_words_when_counted_then_return_count_of_stop_words():
    ...
    # then
    assert actual_results == 2, "Didn't find the expected number of words in the text"
