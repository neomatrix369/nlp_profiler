...
from nlp_profiler.granular_features.emojis import gather_emojis, count_emojis  # noqa
...
def test_given_a_text_with_emoji_when_parsed_then_return_only_emojis():
    ...
    # then
    assert expected_results == actual_results, "Didn't find the two emojis ⚽ and 😁 in the text"
...
def test_given_a_text_with_emoji_when_counted_then_return_number_of_emojis_found():
    ...
    # then
    assert actual_results == 2, "Didn't find the expected two emojis in the text"
