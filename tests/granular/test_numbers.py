...
@pytest.mark.parametrize("text,expected_result,expected_count", text_to_whole_numbers_mapping)
def test_given_text_when_counted_for_whole_numbers_then_return_the_respective_values(
    ...
    assert expected_result == actual_result, (
        "Didn't find the expected number(s) in the text" f"Expected: {expected_result}, Actual: {actual_result}"
    )
...
@pytest.mark.parametrize("text,expected_result,expected_count", text_to_digits_result_mapping)
def test_given_text_when_counted_for_digits_then_return_the_respective_values(
    ...
    # then
    assert expected_result == actual_result, (
        "Didn't find the expected digit(s) in the text" f"Expected: {expected_result}, Actual: {actual_result}"
    )
    ...
    # then
    assert expected_count is actual_result, (
        "Didn't find the expected number of digits in the text" f"Expected: {expected_count}, Actual: {actual_result}"
    )
