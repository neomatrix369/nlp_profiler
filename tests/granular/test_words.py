...
from nlp_profiler.granular_features.words import gather_words, count_words  # noqa
...
def test_given_a_text_with_words_when_counted_then_return_count_of_words():
    ...
    # then
    assert actual_results == 5, "Didn't find the expected number of words in the text"
