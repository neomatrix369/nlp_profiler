...
def test_given_a_text_with_sentences_when_counted_then_return_the_count_of_sentences(text, expected_result):
    # given, when
    actual_result = count_sentences(text)
...
def test_given_a_text_with_sentences_when_parsed_then_return_the_sentences(text: str, expected_result: list):
    # given, when
    actual_result = gather_sentences(text)

    # then
    assert expected_result == actual_result, (
        "Didn't find the expected sentence(s) in the text." f"Expected: {expected_result}, Actual: {actual_result}"
    )
